...
namespace BroMakerLib.Vanilla.Melees
{
    ...
    public class KnifeMelee : MeleeAbility
    {
        public override void Initialize(TestVanDammeAnim owner)
        {
            ...
            meleeHitTerrainSounds = owner.soundHolder.meleeHitTerrainSound;
        }
        ...
        private void PerformKnifeMeleeAttack(bool shouldTryHitTerrain, bool playMissSound)
        {
            ...
            {
                sound.PlaySoundEffectAt(owner.soundHolder.meleeHitSound, 1f, owner.transform.position, 1f, true, false, false, 0f);
                hero.MeleeHasHit = true;
            }
            else if (playMissSound)
            {
                sound.PlaySoundEffectAt(owner.soundHolder.missSounds, 0.3f, owner.transform.position, 1f, true, false, false, 0f);
            }
