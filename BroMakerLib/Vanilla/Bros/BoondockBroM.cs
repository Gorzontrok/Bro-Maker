...
{
    [HeroPreset("BoondockBros", HeroType.BoondockBros)]
    public class BoondockBroM : BoondockBro, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            isLeadBro = true;
            if (billyConnollyPrefab == null) billyConnollyPrefab = bro.billyConnollyPrefab;
            if (secondBroMaterial == null) secondBroMaterial = bro.secondBroMaterial;
            if (avatar1 == null) avatar1 = bro.avatar1;
            if (avatar2 == null) avatar2 = bro.avatar2;
            gameObject.name = gameObject.name.Insert(0, "[LEAD] ");
        }
        #endregion
