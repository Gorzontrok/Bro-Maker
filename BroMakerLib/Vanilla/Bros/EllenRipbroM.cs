...
{
    [HeroPreset("EllenRipbro", HeroType.EllenRipbro)]
    public class EllenRipbroM : EllenRipbro, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.EllenRipbro).As<EllenRipbro>();
            if (bro == null) return;
            ...
            if (flameWavePrefab == null) flameWavePrefab = bro.flameWavePrefab;
        }
        #endregion
