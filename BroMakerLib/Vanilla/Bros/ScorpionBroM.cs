...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class ScorpionBroM : ScorpionBro, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            if (scorpionModeMaterial == null) scorpionModeMaterial = bro.scorpionModeMaterial;
        }
        #endregion
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.ScorpionBro).As<ScorpionBro>();
                if (awakePrefab != null)
                {
