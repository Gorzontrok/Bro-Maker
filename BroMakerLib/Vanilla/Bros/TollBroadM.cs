...
{
    [HeroPreset("TollBroad", HeroType.TollBroad)]
    public class TollBroadM : TollBroad, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.TollBroad).As<TollBroad>();
            if (bro == null) return;
            ...
            if (flameProjectiles == null) flameProjectiles = bro.flameProjectiles;
        }
        #endregion
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.TollBroad).As<TollBroad>();
                if (awakePrefab != null)
                {
