...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class AshBrolliamsM : AshBrolliams, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.AshBrolliams).As<AshBrolliams>();
            if (bro == null) return;
            ...
            if (chainsawStart == null) chainsawStart = bro.chainsawStart;
            if (chainsawSpin == null) chainsawSpin = bro.chainsawSpin;
            if (chainsawWindDown == null) chainsawWindDown = bro.chainsawWindDown;
            if (bloodyAvatar == null) bloodyAvatar = bro.bloodyAvatar;
        }
        #endregion
