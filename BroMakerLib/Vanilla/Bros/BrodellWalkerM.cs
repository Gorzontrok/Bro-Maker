...
{
    [HeroPreset("BrodellWalker", HeroType.BrodellWalker)]
    public class BrodellWalkerM : BrodellWalker, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.BrodellWalker).As<BrodellWalker>();
            if (bro == null) return;
