...
{
    [HeroPreset("BroMax", HeroType.BroMax)]
    public class BroMaxM : BroMax, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.BroMax).As<BroMax>();
            if (bro == null) return;
            ...
            if (boomerang == null) boomerang = bro.boomerang;
