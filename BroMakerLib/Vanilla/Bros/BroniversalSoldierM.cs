...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class BroniversalSoldierM : BroniversalSoldier, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            if (reviveBlastPrefab == null) reviveBlastPrefab = bro.reviveBlastPrefab;
            if (reviveClips == null) reviveClips = bro.reviveClips;
        }
        #endregion
