...
{
    [HeroPreset("MacBrover", HeroType.McBrover)]
    public class McBroverM : McBrover, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.McBrover).As<McBrover>();
            if (bro == null) return;
            ...
            if (turkeyProjectile == null) turkeyProjectile = bro.turkeyProjectile;
        }
        #endregion
