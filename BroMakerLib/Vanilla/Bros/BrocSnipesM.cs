...
{
    [HeroPreset("BroctorDeath", HeroType.Broc)]
    public class BrocSnipesM : BrocSnipes, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.Broc).As<BrocSnipes>();
            if (bro == null) return;
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.Broc).As<BrocSnipes>();
                if (awakePrefab != null)
                {
