...
{
    [HeroPreset("Brommando", HeroType.Brommando)]
    public class BrommandoM : Brommando, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.Brommando).As<Brommando>();
            if (bro == null) return;
