...
{
    [HeroPreset("Xebro", HeroType.Xebro)]
    public class XebroM : Xebro, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.Xebro).As<Xebro>();
            if (bro == null) return;
            ...
            if (chakramPrefab == null) chakramPrefab = bro.chakramPrefab;
