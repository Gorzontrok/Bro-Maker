...
{
    [HeroPreset("CherryBroling", HeroType.CherryBroling)]
    public class CherryBrolingM : CherryBroling, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.CherryBroling).As<CherryBroling>();
            if (bro == null) return;
            ...
            if (rocketGrenade == null) rocketGrenade = bro.rocketGrenade;
        }
        #endregion
