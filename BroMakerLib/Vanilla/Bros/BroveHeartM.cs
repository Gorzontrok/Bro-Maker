...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class BroveHeartM : BroveHeart, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            if (swordPrefab == null) swordPrefab = bro.swordPrefab;
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.BroveHeart).As<BroveHeart>();
                if (awakePrefab != null)
                {
