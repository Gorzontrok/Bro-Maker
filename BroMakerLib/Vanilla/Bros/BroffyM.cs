...
{
    [HeroPreset("Broffy", HeroType.Broffy)]
    public class BroffyM : Broffy, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.Broffy).As<Broffy>();
            if (bro == null) return;
