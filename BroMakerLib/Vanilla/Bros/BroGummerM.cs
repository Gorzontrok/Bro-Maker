...
{
    [HeroPreset("BurtBrommer", HeroType.BroGummer)]
    public class BroGummerM : BroGummer, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.BroGummer).As<BroGummer>();
            if (bro == null) return;
            ...
            if (specialSniperBulletPrefab == null) specialSniperBulletPrefab = bro.specialSniperBulletPrefab;
            if (sachelPackProjectile == null) sachelPackProjectile = bro.sachelPackProjectile;
            if (broGummerSniperTargetPrefab == null) broGummerSniperTargetPrefab = bro.broGummerSniperTargetPrefab;
        }
        #endregion
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.BroGummer).As<BroGummer>();
                if (awakePrefab != null)
                {
