...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class BroGummerM : BroGummer, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            specialSniperBulletPrefab = bro.specialSniperBulletPrefab;
            sachelPackProjectile = bro.sachelPackProjectile;
            broGummerSniperTargetPrefab = bro.broGummerSniperTargetPrefab;
        }
        #endregion
