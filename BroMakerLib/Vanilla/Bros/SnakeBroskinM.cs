...
{
    [HeroPreset("SnakeBroskin", HeroType.SnakeBroSkin)]
    public class SnakeBroskinM : SnakeBroskin, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.SnakeBroSkin).As<SnakeBroskin>();
            if (bro == null) return;
            ...
            if (hologramMaterial == null) hologramMaterial = bro.hologramMaterial;
            gliderAudio = GetComponent<AudioSource>();
        }
        #endregion
