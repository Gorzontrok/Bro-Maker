...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class IndianaBronesM : IndianaBrones, ICustomHero, IAbilityOwner
    {
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.IndianaBrones).As<IndianaBrones>();
                if (awakePrefab != null)
                {
                    useNewDuckingFrames = awakePrefab.useNewDuckingFrames;
                }
