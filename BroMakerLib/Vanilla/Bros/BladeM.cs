...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class BladeM : Blade, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.Blade).As<Blade>();
            if (bro == null) return;
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.Blade).As<Blade>();
                if (awakePrefab != null)
                {
