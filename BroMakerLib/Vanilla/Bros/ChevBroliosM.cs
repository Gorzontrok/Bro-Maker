...
{
    [HeroPreset("ChevBrolios", HeroType.ChevBrolios)]
    public class ChevBroliosM : ChevBrolios, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.ChevBrolios).As<ChevBrolios>();
            if (bro == null) return;
            ...
            if (arousedVoiceHolder == null) arousedVoiceHolder = bro.arousedVoiceHolder;
            if (drowsyVoiceHolder == null) drowsyVoiceHolder = bro.drowsyVoiceHolder;
            if (avatarTired == null) avatarTired = bro.avatarTired;
            if (avatarNormal == null) avatarNormal = bro.avatarNormal;
            if (avatarFrenzy == null) avatarFrenzy = bro.avatarFrenzy;
        }
        #endregion
