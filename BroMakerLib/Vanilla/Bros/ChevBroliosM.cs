...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class ChevBroliosM : ChevBrolios, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            arousedVoiceHolder = bro.arousedVoiceHolder;
            drowsyVoiceHolder = bro.drowsyVoiceHolder;
            avatarTired = bro.avatarTired;
            avatarNormal = bro.avatarNormal;
            avatarFrenzy = bro.avatarFrenzy;
        }
        #endregion
