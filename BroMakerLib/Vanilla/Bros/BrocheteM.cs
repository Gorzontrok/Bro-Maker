...
{
    [HeroPreset("Brochete", HeroType.Brochete)]
    public class BrocheteM : Brochete, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            if (macheteSprayProjectile == null) macheteSprayProjectile = bro.macheteSprayProjectile;
        }
        #endregion
