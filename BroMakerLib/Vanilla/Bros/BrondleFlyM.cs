...
{
    [HeroPreset("SethBrondle", HeroType.BrondleFly)]
    public class BrondleFlyM : BrondleFly, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            if (teleportOutAnimation == null) teleportOutAnimation = bro.teleportOutAnimation;
            if (teleportInAnimation == null) teleportInAnimation = bro.teleportInAnimation;
            if (teleportSound == null) teleportSound = bro.teleportSound;
            if (coveredInBloodMaterial == null) coveredInBloodMaterial = bro.coveredInBloodMaterial;
            if (openMouthBloodyMaterial == null) openMouthBloodyMaterial = bro.openMouthBloodyMaterial;
            if (openMouthMaterial == null) openMouthMaterial = bro.openMouthMaterial;
            if (hoverClip == null) hoverClip = bro.hoverClip;
