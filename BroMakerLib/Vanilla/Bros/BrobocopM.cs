...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class BrobocopM : Brobocop, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            if (targetSystemPrefab == null) targetSystemPrefab = bro.targetSystemPrefab;
            if (chargingSound == null) chargingSound = bro.chargingSound;
            if (finishedChargingSound == null) finishedChargingSound = bro.finishedChargingSound;
            if (gunMaterialDefault == null) gunMaterialDefault = bro.gunMaterialDefault;
            if (gunMaterialOneLight == null) gunMaterialOneLight = bro.gunMaterialOneLight;
            if (gunMaterialOtherLight == null) gunMaterialOtherLight = bro.gunMaterialOtherLight;
            if (gunMaterialBothLights == null) gunMaterialBothLights = bro.gunMaterialBothLights;
        }
        #endregion
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.Brobocop).As<Brobocop>();
                if (awakePrefab != null)
                {
