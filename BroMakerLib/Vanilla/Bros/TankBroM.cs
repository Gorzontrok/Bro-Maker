...
{
    [HeroPreset("TankBro", HeroType.TankBro)]
    public class TankBroM : TankBro, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.TankBro).As<TankBro>();
            if (bro == null) return;
            ...
            if (barageProjectile == null) barageProjectile = bro.barageProjectile;
            if (whistle == null) whistle = bro.whistle;
        }
        #endregion
