...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class BroneyRossM : BroneyRoss, ICustomHero, IAbilityOwner
    {
        ...
        {
            var prefab = HeroController.GetHeroPrefab(HeroType.BroneyRoss);
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.BroneyRoss).As<BroneyRoss>();
                if (awakePrefab != null)
                {
