...
{
    [HeroPreset("MrAnderbro", HeroType.Nebro)]
    public class NebroM : Nebro, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.Nebro).As<Nebro>();
            if (bro == null) return;
            ...
            if (returnZonePrefab == null) returnZonePrefab = bro.returnZonePrefab;
            if (materialArmless == null) materialArmless = bro.materialArmless;
            if (faderSpriteDownPrefab == null) faderSpriteDownPrefab = bro.faderSpriteDownPrefab;
            if (faderSpritePrefab == null) faderSpritePrefab = bro.faderSpritePrefab;
            if (faderSpriteRightPrefab == null) faderSpriteRightPrefab = bro.faderSpriteRightPrefab;
            if (faderSpriteUpPrefab == null) faderSpriteUpPrefab = bro.faderSpriteUpPrefab;
            if (shrapnelSpark == null) shrapnelSpark = bro.shrapnelSpark;
            if (hitPuff == null) hitPuff = bro.hitPuff;
            if (throwingKnife == null) throwingKnife = bro.throwingKnife;
        }
        #endregion
