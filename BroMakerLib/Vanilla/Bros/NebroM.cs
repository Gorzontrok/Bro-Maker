...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class NebroM : Nebro, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            returnZonePrefab = bro.returnZonePrefab;
            materialArmless = bro.materialArmless;
            faderSpriteDownPrefab = bro.faderSpriteDownPrefab;
            faderSpritePrefab = bro.faderSpritePrefab;
            faderSpriteRightPrefab = bro.faderSpriteRightPrefab;
            faderSpriteUpPrefab = bro.faderSpriteUpPrefab;
