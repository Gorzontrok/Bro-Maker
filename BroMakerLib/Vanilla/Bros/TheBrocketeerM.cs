...
{
    [HeroPreset("Brocketeer", HeroType.TheBrocketeer)]
    public class TheBrocketeerM : TheBrocketeer, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.TheBrocketeer).As<TheBrocketeer>();
            if (bro == null) return;
            ...
            if (liftOffBlastFlameWall == null) liftOffBlastFlameWall = bro.liftOffBlastFlameWall;
            if (jetpackLiftSound == null) jetpackLiftSound = bro.jetpackLiftSound;
            if (jetpackDiveSound == null) jetpackDiveSound = bro.jetpackDiveSound;
        }
        #endregion
