...
{
    [HeroPreset("Bronan", HeroType.BronanTheBrobarian)]
    public class BronanTheBrobarianM : BronanTheBrobarian, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.BronanTheBrobarian).As<BronanTheBrobarian>();
            if (bro == null) return;
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.BronanTheBrobarian).As<BronanTheBrobarian>();
                if (awakePrefab != null)
                {
