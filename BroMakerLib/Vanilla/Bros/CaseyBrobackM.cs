...
{
    [HeroPreset("CaseyBroback", HeroType.CaseyBroback)]
    public class CaseyBrobackM : CaseyBroback, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.CaseyBroback).As<CaseyBroback>();
            if (bro == null) return;
