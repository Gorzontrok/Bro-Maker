...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class BronnarJensenM : BronnarJensen, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            if (primaryGrenade == null) primaryGrenade = bro.primaryGrenade;
            if (remoteControlVehiclePrefab == null) remoteControlVehiclePrefab = bro.remoteControlVehiclePrefab;
        }
        #endregion
        ...
        protected override void Awake()
        {
            try
            {
                ...
                var awakePrefab = HeroController.GetHeroPrefab(HeroType.BronnarJensen).As<BronnarJensen>();
                if (awakePrefab != null)
                {
