...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class DesperabroM : Desperabro, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            if (campaBroMaterial == null) campaBroMaterial = bro.campaBroMaterial;
            if (campaBroGuitarMaterial == null) campaBroGuitarMaterial = bro.campaBroGuitarMaterial;
            if (campaBroProjectile == null) campaBroProjectile = bro.campaBroProjectile;
            if (quinoBroGuitarMaterial == null) quinoBroGuitarMaterial = bro.quinoBroGuitarMaterial;
            if (quinoBroMaterial == null) quinoBroMaterial = bro.quinoBroMaterial;
            if (quinoBroProjectile == null) quinoBroProjectile = bro.quinoBroProjectile;
        }
        #endregion
