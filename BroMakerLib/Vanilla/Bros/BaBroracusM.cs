...
namespace BroMakerLib.Vanilla.Bros
{
    ...
    public class BaBroracusM : BaBroracus, ICustomHero, IAbilityOwner
    {
        ...
        protected virtual void FixNullVariableLocal()
        {
            ...
            if (flameSound == null) flameSound = bro.flameSound;
            if (flameSoundEnd == null) flameSoundEnd = bro.flameSoundEnd;
            if (projectile2 == null) projectile2 = bro.projectile2;
            if (projectile3 == null) projectile3 = bro.projectile3;
        }
        #endregion
