...
{
    [HeroPreset("BroInBlack", HeroType.Brononymous)]
    public class BrononymousM : Brononymous, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.Brononymous).As<Brononymous>();
            if (bro == null) return;
            ...
            if (neuraliserPrefab == null) neuraliserPrefab = bro.neuraliserPrefab;
        }
        #endregion
