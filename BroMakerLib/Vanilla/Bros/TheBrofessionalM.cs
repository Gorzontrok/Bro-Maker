...
{
    [HeroPreset("TheBrofessional", HeroType.TheBrofessional)]
    public class TheBrofessionalM : TheBrofessional, ICustomHero, IAbilityOwner
    {
        ...
        {
            var bro = HeroController.GetHeroPrefab(HeroType.TheBrofessional).As<TheBrofessional>();
            if (bro == null) return;
            ...
            if (matildaTargettingWavePrefab == null) matildaTargettingWavePrefab = bro.matildaTargettingWavePrefab;
        }
        #endregion
